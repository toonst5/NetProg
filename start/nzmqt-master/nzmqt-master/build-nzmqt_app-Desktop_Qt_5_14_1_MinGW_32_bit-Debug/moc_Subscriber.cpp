...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_nzmqt__samples__pubsub__Subscriber_t, stringdata0) + ofs \
...
static const qt_meta_stringdata_nzmqt__samples__pubsub__Subscriber_t qt_meta_stringdata_nzmqt__samples__pubsub__Subscriber = {
    {
QT_MOC_LITERAL(0, 0, 34), // "nzmqt::samples::pubsub::Subsc..."
QT_MOC_LITERAL(1, 35, 12), // "pingReceived"
QT_MOC_LITERAL(2, 48, 0), // ""
QT_MOC_LITERAL(3, 49, 7), // "message"
QT_MOC_LITERAL(4, 57, 15) // "messageReceived"

    },
    "nzmqt::samples::pubsub::Subscriber\0"
    "pingReceived\0\0message\0messageReceived"
};
...
void nzmqt::samples::pubsub::Subscriber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Subscriber::*)(const QList<QByteArray> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Subscriber::pingReceived)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject nzmqt::samples::pubsub::Subscriber::staticMetaObject = { {
    QMetaObject::SuperData::link<SampleBase::staticMetaObject>(),
    qt_meta_stringdata_nzmqt__samples__pubsub__Subscriber.data,
    qt_meta_data_nzmqt__samples__pubsub__Subscriber,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *nzmqt::samples::pubsub::Subscriber::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_nzmqt__samples__pubsub__Subscriber.stringdata0))
