...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_nzmqt__samples__reqrep__Replier_t, stringdata0) + ofs \
...
static const qt_meta_stringdata_nzmqt__samples__reqrep__Replier_t qt_meta_stringdata_nzmqt__samples__reqrep__Replier = {
    {
QT_MOC_LITERAL(0, 0, 31), // "nzmqt::samples::reqrep::Replier"
QT_MOC_LITERAL(1, 32, 15), // "requestReceived"
QT_MOC_LITERAL(2, 48, 0), // ""
QT_MOC_LITERAL(3, 49, 7), // "request"
QT_MOC_LITERAL(4, 57, 9), // "replySent"
QT_MOC_LITERAL(5, 67, 14) // "receiveRequest"

    },
    "nzmqt::samples::reqrep::Replier\0"
    "requestReceived\0\0request\0replySent\0"
    "receiveRequest"
};
...
void nzmqt::samples::reqrep::Replier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Replier *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (Replier::*)(const QList<QByteArray> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Replier::requestReceived)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Replier::*)(const QList<QByteArray> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Replier::replySent)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject nzmqt::samples::reqrep::Replier::staticMetaObject = { {
    QMetaObject::SuperData::link<SampleBase::staticMetaObject>(),
    qt_meta_stringdata_nzmqt__samples__reqrep__Replier.data,
    qt_meta_data_nzmqt__samples__reqrep__Replier,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *nzmqt::samples::reqrep::Replier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_nzmqt__samples__reqrep__Replier.stringdata0))
